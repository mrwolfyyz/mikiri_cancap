...
- **Variable Name**: `PRECISION_PSE_CX`
  - **Usage**: Set this environment variable to `73bc98f068711495f` for all Cloud Functions that use this PSE
- **Variable Name**: `RECALL_PSE_CX_2` (reuses this same PSE)
  - **Usage**: Set this environment variable to `73bc98f068711495f` (same value as PRECISION_PSE_CX)
...
8. Add all sites listed in the "Site Restrictions" section above
9. Save the PSE and copy the Search Engine ID (CX value) - it should match `73bc98f068711495f` if recreating the exact configuration
10. Set both `PRECISION_PSE_CX` and `RECALL_PSE_CX_2` environment variables to this same CX ID
