...
def vertex_ai_score(seed: dict[str, Any], queries_payload: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    system_prompt = (
        ...
        "- Inclusion bias: When uncertain, include the handle at LOW confidence rather than dropping it. The downstream report will show confidence levels to the reader.\n"
