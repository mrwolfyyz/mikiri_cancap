...
def upload_single_file(
    ...
    file_meta = upload_file_to_drive(
        drive_service,
        file_path,
        file_name,
        parent_folder_id
...
def on_job_updated(event: CloudEvent) -> None:
    ...
    """
    print(f"[SkipTraceReportGenerator] Function triggered!")
    job_id = None
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if markdown_reports:
                ...
                print(f"[SkipTraceReportGenerator] ✓ Stored markdown reports in Firestore for chat feature")
            
            job_ref.set(update_data, merge=True)
            
            print(f"[SkipTraceReportGenerator] ✓ Updated Firestore: status=complete, reports_generated=true")
