    ...
    if company_domain:
        ...
        if company_domain:
            ...
            if enrichment_data and enrichment_data.get('domains') and company_domain in enrichment_data['domains']:
                ...
                print(f"[Identity Report SkipTrace] WARNING: Falling back to inline whois lookup for company domain {company_domain} (domain_enrichment data missing)")
                company_whois_result = get_domain_registration_date(company_domain)
                print(f"[Identity Report SkipTrace] WARNING: Falling back to inline MX lookup for company domain {company_domain} (domain_enrichment data missing)")
                company_mx_result = check_domain_mx_records(company_domain)
